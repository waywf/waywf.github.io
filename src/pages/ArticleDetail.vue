  ...
  <div class="min-h-screen flex flex-col bg-[#0F1419]">
    ...
    <div v-if="article" class="flex-1">
      ...
      <section class="py-12 md:py-16 border-b border-[#2D3447]">
        <div class="container max-w-3xl">
          <RouterLink to="/articles" class="inline-flex items-center gap-2 text-[#00FF41] hover:text-[#FF006E] transition-colors mb-8">
          ...
          <h1 class="text-4xl md:text-5xl font-bold mb-6 text-[#E0E0E0]">
            {{ article.title }}
          </h1>

          <div class="flex flex-wrap gap-6 text-[#A0A0A0]">
            ...
            <div class="flex items-center gap-2">
              <svg class="w-5 h-5 text-[#FF006E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section class="py-12 md:py-16">
        <div class="container max-w-3xl">
          ...
          <!-- Tags -->
          <div class="mt-12 pt-8 border-t border-[#2D3447]">
            <h3 class="text-[#00FF41] font-bold mb-4">标签</h3>
            <div class="flex flex-wrap gap-3">
              <span
                v-for="tag in article.tags"
                :key="tag"
                class="px-4 py-2 bg-[#FF006E]/20 text-[#FF006E] rounded font-bold hover:bg-[#FF006E]/30 transition-colors cursor-pointer"
              >
                #{{ tag }}
              </span>
            </div>
    ...
    <div v-else class="flex-1 flex items-center justify-center">
      <div class="text-center">
        <h1 class="text-4xl font-bold text-[#FF006E] mb-4">404</h1>
        <p class="text-[#A0A0A0] mb-8">文章未找到</p>
        <RouterLink to="/articles" class="inline-flex items-center gap-2 px-6 py-3 bg-[#00FF41] text-[#0F1419] font-bold rounded hover:shadow-lg hover:shadow-[#00FF41]/50 transition-all">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
          </svg>
          返回文章列表
