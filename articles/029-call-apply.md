...
不急，我们可以从 Arguments 对象中取值，取出第二个到最后一个参数，然后放到一个数组里。比如这样：
...
call 和 apply 是 JavaScript 中非常重要的方法，它们可以改变函数的 this 指向，并且可以传递参数。通过模拟实现 call 和 apply，我们可以更深入地理解它们的工作原理。
